...
<html lang="en">
   <head>
      ...
      <title>Aplikasi RAB - Admin</title>
...
<body>
   ...
   <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0;">
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<?php echo    base_url();?>index.php/admin/admin">CV. Dekarobe</a>
      </div>
      <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">
Hai, Admin ! &nbsp; <a href="<?php echo base_url('index.php/login/logout');?>" class="btn btn-danger square-btn-adjust">Logout</a>
      </div>
   </nav>
   <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
         <ul class="nav" id="main-menu">
            ...
            <li>
               <a href="<?php echo base_url();?>index.php/admin/admin"><i class="fa fa-edit fa-3x"></i> Kontrak Kerja</a>
            </li>
            <li>
               <a href="<?php echo base_url();?>index.php/admin/admin"><i class="fa fa-edit fa-3x"></i> Usulan Pradesain</a>
            </li>
            <li>
               <a href="<?php echo base_url();?>index.php/admin/admin"><i class="fa fa-edit fa-3x"></i> Perencanaan Pembangunan</a>
            </li>
            <li>
               <a href="<?php echo base_url();?>index.php/admin/admin"><i class="fa fa-edit fa-3x"></i> Laporan</a>
            </li>
   ...
   <div class="col-md-12">
   <h2>Master Produk</h2>
   <h5>Olah Data Produk | CV. Dekarobe </h5>
   </div>
   </div>
   <!-- TABLE -->
   <hr />
   ...
   <!-- Tambah Modals -->
   <form action="<?php echo base_url();?>index.php/admin/simpan_produk" method="post" enctype="multipart/form-data">
   ...
   <!-- Edit Modals -->
   <form action="<?php echo base_url();?>index.php/admin/edit_produk" method="post" enctype="multipart/form-data">
      ...
      if(!empty($results)) {
         foreach ($results as $row)
         {
            ...
            echo '<tr>
                     ...
                     <a href="'.base_url().'index.php/admin/hapus_produk?id='.$id.'&img='.$img.'" onclick="return check_hapus(\''.$id.'\',\''.$nama.'\')"><span class="fa fa-eraser"></span> Hapus</a>
                     </td>
                  </tr>';
            $no++;
         }
