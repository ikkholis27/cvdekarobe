...
<body>
   ...
   <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0;">
      <div class="navbar-header">
         ...
         <a class="navbar-brand" href="<?php echo    base_url();?>index.php/welcome/welcome">CV. Dekarobe</a>
      </div>
      <div style="color: white;padding: 15px 50px 5px 50px;float: right;font-size: 16px;">
Akses Terakhir : 04 Juli 2018 &nbsp; <a href="<?php echo base_url('index.php/login/logout');?>" class="btn btn-danger square-btn-adjust">Logout</a>
      </div>
   </nav>
   <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
         <ul class="nav" id="main-menu">
            ...
            <li>
               <a href="<?php echo base_url();?>index.php/welcome/welcome"><i class="fa fa-edit fa-3x"></i> Usulan Pradesain</a>
            </li>
            <li>
               <a href="<?php echo base_url();?>index.php/welcome/welcome"><i class="fa fa-edit fa-3x"></i> Perencanaan Pembangunan</a>
            </li>
            <li>
               <a href="<?php echo base_url();?>index.php/welcome/welcome"><i class="fa fa-edit fa-3x"></i> Laporan</a>
            </li>
