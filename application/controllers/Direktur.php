...
class Direktur extends CI_Controller {
	 ...
	 * 		http://example.com/index.php/direktur
	 *	- or -
	 * 		http://example.com/index.php/direktur/index
	 *	- or -
	 * Since this controller is set as the default controller in
	 * config/routes.php, it's displayed at http://example.com/
	 *
	 * So any other public methods not prefixed with an underscore will
	 * map to /index.php/direktur/<method_name>
	...
	*/
	...
	public function __construct() {
	   ...
	   {
	      $config["base_url"] = base_url().'index.php/direktur/direktur';
